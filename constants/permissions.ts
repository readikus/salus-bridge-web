...
export const PERMISSIONS = {
  ...
  MANAGE_MILESTONE_ACTIONS: "manage:milestone_actions",
  VIEW_MILESTONE_ACTIONS: "view:milestone_actions",
  CREATE_COMMUNICATION_LOG: "create:communication_log",
  VIEW_COMMUNICATION_LOG: "view:communication_log",
} as const;
...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  [UserRole.PLATFORM_ADMIN]: [
    ...
    PERMISSIONS.MANAGE_MILESTONE_ACTIONS,
    PERMISSIONS.VIEW_MILESTONE_ACTIONS,
    PERMISSIONS.CREATE_COMMUNICATION_LOG,
