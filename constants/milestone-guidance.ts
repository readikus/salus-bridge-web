...
export const MILESTONE_GUIDANCE: Record<string, MilestoneGuidance> = {
  DAY_1: {
    actionTitle: "Contact your employee",
    managerGuidance:
    ...
    instructions: [
      "Send a brief, supportive message via phone or email",
      "Do not ask for medical details at this stage",
      "Record the absence start date",
      "Ensure the employee knows who to contact if they need anything",
    ],
    employeeView:
  ...
  DAY_3: {
    actionTitle: "Remind about GP visit",
    managerGuidance:
    ...
    instructions: [
      "Check in with the employee about how they are feeling",
      "Mention the fit note requirement after 7 days as helpful information",
      "Suggest booking a GP appointment if they haven't already",
      "Reassure them that their workload is being covered",
    ],
    employeeView:
  ...
  DAY_7: {
    ...
    instructions: [
      "Request a fit note from the employee",
      "Explain the fit note process if they are unfamiliar",
      "Update the case to reflect long-term status",
      "Discuss any expected return date if the employee feels comfortable sharing",
      "Reassure them about job security and ongoing support",
    ],
    employeeView:
  ...
  WEEK_2: {
    actionTitle: "Conduct welfare check-in",
    managerGuidance:
    ...
    instructions: [
      "Schedule a brief welfare call or send a supportive message",
      "Ask how they are feeling without pressuring for a return date",
      "Remind about fit note renewal if applicable",
      "Document the check-in outcome",
      "Ask if any workplace adjustments might help when they are ready to return",
    ],
    employeeView:
  ...
  WEEK_3: {
    actionTitle: "Chase fit note renewal",
    managerGuidance:
    ...
    instructions: [
      "Check if the current fit note is expiring or has expired",
      "Request a renewed fit note if needed",
      "Continue to express support and understanding",
      "Update the case record with any new information",
    ],
    employeeView:
  ...
  WEEK_4: {
    actionTitle: "Request GP or occupational health report",
    managerGuidance:
    ...
    instructions: [
      "Discuss an occupational health referral with HR",
      "Obtain employee consent for the referral",
      "Send the referral with relevant job role information",
      "Ensure the employee understands the purpose is to support their return",
      "Chase the current fit note renewal if applicable",
    ],
    employeeView:
  ...
  WEEK_6: {
    actionTitle: "Create a plan of action",
    managerGuidance:
    ...
    instructions: [
      "Review any occupational health reports received",
      "Draft a plan of action with input from HR",
      "Invite the employee to contribute to the plan",
      "Include reasonable adjustments, phased return options, and support measures",
      "Set a review date for the plan",
      "Document and share the plan with the employee",
    ],
    employeeView:
  ...
  WEEK_10: {
    actionTitle: "Conduct first evaluation meeting",
    managerGuidance:
    ...
    instructions: [
      "Schedule the evaluation meeting with reasonable notice",
      "Review the plan of action before the meeting",
      "Discuss progress, barriers, and any new information",
      "Update the plan of action based on the discussion",
      "Set the date for the next evaluation",
      "Document the meeting outcome and share with the employee",
    ],
    employeeView:
  ...
  WEEK_14: {
    actionTitle: "Conduct evaluation meeting",
    managerGuidance:
    ...
    instructions: [
      ...
      "Review progress since the last evaluation",
      "Consider requesting an updated occupational health report if circumstances have changed",
      "Update the plan of action as needed",
      "Set the date for the next evaluation",
  ...
  WEEK_18: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Discuss long-term outlook openly and sensitively",
      "Review whether current adjustments and support are adequate",
      "Consider whether further specialist input is needed",
  ...
  WEEK_22: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Review all support measures and adjustments in place",
      "Discuss realistic timelines for return",
      "Consider whether ill-health retirement or other options should be explored",
      "Update the plan of action",
      "Document the meeting outcome",
    ],
    employeeView:
  ...
  WEEK_26: {
    actionTitle: "Conduct six-month evaluation",
    managerGuidance:
    ...
    instructions: [
      "Schedule a comprehensive review meeting with HR involvement",
      "Prepare a full case summary including all medical evidence",
      "Review all adjustments and support measures provided to date",
      "Discuss long-term prognosis and realistic return scenarios",
      "Consider formal options if return is unlikely in the medium term",
  ...
  WEEK_30: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Focus on realistic return planning",
      "Review any updated medical evidence",
      "Discuss alternative role options if applicable",
      "Update the plan of action",
      "Document the meeting outcome",
    ],
    employeeView:
  ...
  WEEK_34: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Review the latest medical position",
      "Discuss formal options with HR before the meeting",
      "Be transparent about the organisation's considerations",
      "Ensure the employee understands their rights and any support available",
      "Document the meeting outcome",
    ],
    employeeView:
  ...
  WEEK_38: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Work with HR to prepare for the discussion",
      "Review all options available to both parties",
  ...
  WEEK_42: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Prepare a comprehensive case review with HR",
      "Discuss the approaching 52-week capability review threshold",
      "Ensure all documentation is complete and accurate",
      "Be clear about the formal process while showing empathy",
      "Document the meeting outcome",
    ],
    employeeView:
  ...
  WEEK_46: {
    ...
    instructions: [
      "Schedule the evaluation meeting",
      "Formally advise of the approaching capability review process",
      "Ensure the employee understands their rights and options",
      "Offer access to employee assistance programmes",
      "Coordinate with HR on capability review preparation",
      "Document the meeting and communications thoroughly",
    ],
    employeeView:
  ...
  WEEK_50: {
    actionTitle: "Conduct pre-review evaluation",
    managerGuidance:
    ...
    instructions: [
      "Schedule the final pre-review evaluation",
      "Provide written details of the capability review process",
      "Ensure the employee knows their right to representation",
      "Review all evidence, adjustments, and support provided",
      "Give the employee opportunity to provide any final medical evidence",
  ...
  WEEK_52: {
    actionTitle: "Initiate capability review",
    managerGuidance:
    ...
    instructions: [
      "Issue formal capability review notification in writing",
      "Follow the organisation's capability review procedure exactly",
      "Ensure HR is fully involved in all stages",
      "Provide the employee with all relevant documentation",
      "Confirm the employee's right to representation",
      "Consider all options: return to role, alternative role, ill-health retirement, termination",
      "Document every step of the process thoroughly",
      "Ensure decisions are fair, consistent, and legally compliant",
    ],
    employeeView:
