...
export default async function DashboardPage() {
  ...
  if ((isOrgAdmin || isHR) && sessionUser.currentOrganisationId) {
    const stats = await OrganisationService.getDashboardStats(sessionUser.currentOrganisationId);
    const orgName = sessionUser.roles.find((r) => r.organisationId === sessionUser.currentOrganisationId)?.organisationName || "Organisation";
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">
                {stats.departments.length > 0
                  ? stats.departments.slice(0, 3).map((d) => d.name).join(", ")
                  : "No departments yet"}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">Available in Phase 2</p>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {stats.departments.map((dept) => (
                    <div key={dept.id} className="flex items-center justify-between rounded-md border border-gray-200 p-3">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500">Absence tracking in Phase 2</p>
            </CardContent>
          </Card>
  ...
  const displayName = [sessionUser.firstName, sessionUser.lastName].filter(Boolean).join(" ") || sessionUser.email;
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="transition-shadow hover:shadow-md">
          ...
          <CardContent>
            <p className="text-sm text-gray-600">Report and track your absences.</p>
            <p className="mt-2 text-xs text-gray-400">Coming in Phase 2</p>
          </CardContent>
        </Card>
